...
function Weeklyoffercard({customClass, product}) {
  return (
    ...
    style={{ backgroundImage: `url(${product.url})`}}>
        ...
        <button to='/Cart' className='w-fit flex gap-2 py-1 px-2 text-xs bg-white rounded-[12px] font-semibold cursor-pointer'>Shop now<img className='pt-1' src="src/assets/icon/arrowright.svg" alt="" /></button>
    </div>
  )
}
